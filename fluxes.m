function flux = fluxes(conn,type)
%fluxes calculats the total/in/out fluxes the nodes in a graph
%
%   Input: CONN is a connectivity matrix
%          TYPE is a string specifying the flux: total ('tot'), in ('in')
%            or out ('out')
%
%   Output: FLUX is the flux
%
%This work is licensed under the Creative Commons Attribution-NonCommercial-ShareAlike 
%3.0 Unported License. See notes at the end of this file for more information.

% Note that the flux is basically equal to the strength but with retention.
