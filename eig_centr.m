function eigc = eig_centr(conn)
%eig_centrality calculats the eigenvalue centrality of a node
%
%   Input: CONN is a connectivity matrix
%
%   Output: EIGC is the array with the eigenvalue centrality values
%
