...
%conncomp calculates the largest connected component of a graph
%
% Inputs: CONN is a connectivity matrix (either weigthed or not)
% Output: idex of the sites in the largedt connected component
%
