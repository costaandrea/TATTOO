function rho = density(conn)
%density calculates the density of a matrix (number of non-zero elements)
%
%   Input: CONN is a matrix
%
%   Output: RHO is the density of CONN
%
...
rho = numel(find(conn>0))/numel(conn);
